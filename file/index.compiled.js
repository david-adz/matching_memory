...
exports.selectVisibleIDs = exports.selectBoard = exports.resetCards = exports.flipCard = exports.setBoard = exports.boardReducer = void 0;
...
var selectVisibleIDs = function selectVisibleIDs(state) {
  return state.board.filter(card.visible).map(function (card) {
    return card.id;
  });
};
...
var Card = function Card(_ref) {
  ...
  var visibleIDs = (0, _reactRedux.useSelector)(_boardSlice.selectVisibleIDs); // flip card action
